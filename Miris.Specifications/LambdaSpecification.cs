...
namespace Miris.Specifications
{
    public class LambdaSpecification<T> : Specification<T>
    {
        ...
        protected Func<T, bool> PredicadoCompilado =>
            _predicadoCompilado ?? (_predicadoCompilado = Predicado.Compile());
        ...
        public static LambdaSpecification<T> operator &(LambdaSpecification<T> leftSide,
            LambdaSpecification<T> rightSide)
        {
